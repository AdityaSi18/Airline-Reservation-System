...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		String[] sItem1={"Trivandrum" ,"Bangalore", "Chennai ", "Delhi", "Goa", "Hyderabad", "Kolkata", "Lucknow", "Mumbai", "Vishakapatnam"};
		...
		LBookingDetails = new JLabel("<html><b><font color=\"#ADD8E6\">Booking Details</font></b></html>");
		...
		PPanel1.add(LImg1);
		PPanel1.setBackground(Color.gray);
