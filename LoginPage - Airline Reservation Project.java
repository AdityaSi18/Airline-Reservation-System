...
public class LoginPage extends JFrame
{
	...
	JFrame jframe = new JFrame("AIRLINE RESERVATION PROJECT BY ADITYA SINGH");
	...
	JLabel LUserName = new JLabel("<html><B>UserName</B></html>");
	JLabel LPassword = new JLabel("<html><B>Password</B></html>");
	...
	public LoginPage()
	{
		...
		PFlightTypes.setBackground(Color.yellow);
		PLogin.setBackground(Color.ORANGE);
		PFlightDetails.setBackground(Color.black);
